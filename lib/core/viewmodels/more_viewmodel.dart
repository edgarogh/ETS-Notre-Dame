...
class MoreViewModel extends FutureViewModel {
  ...
  static Future<bool> launchInAppReview() async {
    late final PreferencesService preferencesService = locator<PreferencesService>();
    late final InAppReviewService inAppReviewService = locator<InAppReviewService>();
